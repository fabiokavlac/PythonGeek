...
# Trabalhando com os itens da tabela
...
lista4 = list(range(1111))
lista5 = lista4.copy()
#lista5.pop() #remove um elemento
#print(len(lista5)) #len consulta quantos elementos a tabela tem
print(lista5)
lista5.clear()
print(lista5)
"""
